	...
	switch (index) {
		...
		case paramConnectLfo1:
			...
			parameter.enumValues.restrictedMode = true;
			{
				...
				channels[0].label = "none";
				channels[0].value = 0;
				channels[0].label = "division";
				channels[0].value = 1;
				channels[0].label = "noteLengthParam";
				channels[0].value = 2;
				channels[0].label = "octaveSpread";
				channels[0].value = 3;
				channels[0].label = "swing";
				channels[0].value = 4;
				channels[0].label = "randomizeTimming";
				channels[0].value = 5;
				channels[0].label = "velocityMode";
				channels[0].value = 6;
				channels[0].label = "velocityCurve"   ;
				channels[0].value = 7;
				channels[0].label = "curveDepth";
				channels[0].value = 8;
				channels[0].label = "curveClip";
				channels[0].value = 9;
				channels[0].label = "patternVel1";
				channels[0].value = 10;
				channels[0].label = "patternVel2";
				channels[0].value = 11;
				channels[0].label = "patternVel3";
				channels[0].value = 12;
				channels[0].label = "patternVel4";
				channels[0].value = 13;
				channels[0].label = "patternVel5";
				channels[0].value = 14;
				channels[0].label = "patternVel6";
				channels[0].value = 15;
				channels[0].label = "patternVel7";
				channels[0].value = 16;
				channels[0].label = "patternVel8";
				channels[0].value = 17;
			}
			break;
		case paramLFO1depth:
